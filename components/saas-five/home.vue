<template>
    <div>
        <rs-module-wrap id="rev_slider_10_1_wrapper" data-alias="sofbox-8" data-source="gallery" style="background:transparent;padding:0;margin:0px auto;margin-top:0;margin-bottom:0;">
		<rs-module id="rev_slider_10_1" style="display:none;" data-version="6.1.3">
		<rs-slides>
		<rs-slide data-key="rs-4" data-title="Slide" data-anim="ei:d;eo:d;s:1000;r:0;t:fade;sl:0;">
		<img src="../../static/revslider/assets/index-8/transparent.png" data-bg="p:right center;" class="rev-slidebg" data-no-retina>
		<!--
		--><rs-layer
		id="slider-4-slide-4-layer-2"
		data-type="image"
		data-rsp_ch="on"
		data-xy="x:l,l,c,c;xo:804px,804px,33px,26px;y:t,t,m,m;yo:186px,186px,201px,162px;"
		data-text="w:normal;s:20,20,9,5;l:0,0,12,7;"
		data-dim="w:869px,869px,437px,231px;h:610px,610px,307px,162px;"
		data-frame_0="sX:0.9;sY:0.9;"
		data-frame_1="st:2060;sp:1000;sR:2060;"
		data-frame_999="o:0;st:w;sR:5940;"
		style="z-index:11;font-family:Roboto;"
		><img src="../../static/revslider/assets/index-8/49-min.png" alt="images" width="829" height="582" data-no-retina>
		</rs-layer><!--
		--><rs-layer
		...
		><img src="../../static/revslider/assets/index-8/Untitled-11.png" alt="images" width="1071" height="864" data-no-retina>
		</rs-layer><!--
		--><rs-layer
		...
		>Sofbox is the best Software<br />
		landing website ever.
		</rs-layer><!--
		--><rs-layer
		...
		data-type="button"
		data-rsp_ch="on"
		data-xy="x:l,l,c,c;xo:143px,143px,-5px,1px;y:t,t,m,m;yo:562px,562px,-25px,18px;"
		...
		style="z-index:15;background:linear-gradient(90deg, rgba(109,115,239,1) 0%, rgba(163,120,252,1) 100%);font-family:var(--body-font-family);"
		>Read More
		</rs-layer><!--
		--><rs-layer
		...
		data-type="image"
		data-rsp_ch="on"
		data-xy="xo:729px,729px,162px,112px;yo:366px,366px,485px,359px;"
		data-text="w:normal;s:20,20,9,5;l:0,0,12,7;"
		data-dim="w:304px,304px,147px,90px;h:479px,479px,232px,143px;"
		data-frame_0="y:100%;"
		data-frame_0_mask="u:t;"
		...
		><img src="../../static/revslider/assets/index-8/48-min.png" alt="images" width="304" height="479" data-no-retina>
		</rs-layer><!--
		--><rs-layer
		id="slider-4-slide-4-layer-19"
		data-type="image"
		data-rsp_ch="on"
		data-xy="xo:812px,812px,605px,373px;yo:128px,128px,324px,199px;"
		data-text="w:normal;s:20,20,9,5;l:0,0,12,7;"
		...
		><img src="../../static/revslider/assets/index-8/56.png" alt="images" width="157" height="153" data-no-retina>
		</rs-layer><!--
		--><rs-layer
		...
		><img src="../../static/revslider/assets/index-8/04-min.png" alt="images" width="790" height="633" data-no-retina>
		</rs-layer><!--
		-->						</rs-slide>
		</rs-slides>
