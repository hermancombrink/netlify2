<template>
  <rs-module-wrap id="rev_slider_5_1_wrapper" data-alias="sofbox-1" data-source="gallery" style="background:transparent;padding:0;margin:0px auto;margin-top:0;margin-bottom:0;">
      <rs-module id="rev_slider_5_1" style="display:none;" data-version="6.2.1">
        <rs-slides>
          ...
          <img src="../../static/revslider/assets/transparent.png" alt="img" class="rev-slidebg" data-no-retina>
          <rs-layer
          ...
          style="z-index:8;"
          ><img src="../../static/revslider/assets/01-7.png" alt="img" width="1208" height="1232" data-no-retina>
          </rs-layer>
          <rs-layer
          ...
          style="z-index:18;"
          ><img src="../../static/revslider/assets/06-2.png" alt="img" width="625" height="567" data-no-retina>
          </rs-layer>
          <rs-layer
          ...
          style="z-index:17;"
          ><img src="../../static/revslider/assets/02-2.png" alt="img" width="591" height="632" data-no-retina>
          </rs-layer>
          <rs-layer
          ...
          style="z-index:16;"
          ><img src="../../static/revslider/assets/04.png" alt="img" width="157" height="365" data-no-retina>
          </rs-layer>
         --><rs-layer
		...
		style="z-index:11;background-color:#ebf2ff;font-family:var(--body-font-family);cursor:pointer;"
		...
		data-frame_hover="c:#fff;bgc:#377dff;bor:90px,90px,90px,90px;"
		style="z-index:9;background-color:#ebf2ff;font-family:var(--body-font-family);cursor:pointer;"
		...
		data-frame_999="o:0;st:w;sR:4970;"
		data-frame_hover="c:#fff;bgc:#377dff;bor:90px,90px,90px,90px;"
		style="z-index:10;background-color:#ebf2ff;font-family:var(--body-font-family);cursor:pointer;"
		><i class="fa fa-twitter" aria-hidden="true"></i>
          ...
          style="z-index:13;"
          ><img src="../../static/revslider/assets/05-2.png" alt="img" width="412" height="483" data-no-retina>
          </rs-layer>
          <rs-layer
          ...
          style="z-index:14;"
          ><img src="../../static/revslider/assets/04-3.png" alt="img" width="414" height="483" data-no-retina>
          </rs-layer>
          <rs-layer
          id="slider-5-slide-7-layer-14"
          data-type="image"
          data-rsp_ch="on"
          data-xy="xo:1259px,805px,239px,94px;yo:691px,442px,390px,307px;"
          data-text="w:normal;s:20,12,9,5;l:0,16,12,7;"
          data-dim="w:380px,243px,184px,96px;h:326px,208px,158px,82px;"
          data-frame_0="y:50,32,24,14;"
          data-frame_1="st:2270;sp:1000;sR:2270;"
          data-frame_999="o:0;st:w;sR:5730;"
          style="z-index:15;"
          ><img src="../../static/revslider/assets/03-2.png" alt="img" width="482" height="414" data-no-retina>
          </rs-layer>
          <rs-layer
          ...
          style="z-index:21;background-color:#377dff;font-family:var(--body-font-family);"
          >Read More
          </rs-layer>
      </rs-slide>
    </rs-slides>
