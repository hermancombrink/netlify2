                      ...
                      <div class="form-group">
                        ...
                        <div class="ui segment">
                          <div id="user_range_2" class="ui range input-range">
                            <div class="inner">
                              <div class="track" />
                              <div class="track-fill" style="width: 0px;" />
                              <div class="thumb" style="left: -10px;" />
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div class="pricing-table">
              <ul id="pills-tab" class="nav center-btn nav-pills" role="tablist">
                <li v-for="(tab,index) in tabs" :key="index" class="nav-item">
                  <a
                    :id="tab.id"
                    :class="tab.active ? 'nav-link active1 ' : 'nav-link'"
                    data-toggle="pill"
                    :href="'#' + tab.href"
                    role="tab"
...
export default {
  ...
  mounted () {
    setTimeout(()=>{
      sofbox.activeTabPane();
      sofbox.pricingProcess()
    },1000)
