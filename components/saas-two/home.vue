<template>
    <div>
        	<!-- START sofbox7 REVOLUTION SLIDER 6.1.3 --><p class="rs-p-wp-fix"></p>
		<rs-module-wrap id="rev_slider_9_1_wrapper" data-alias="sofbox-7" data-source="gallery" style="background:transparent;padding:0;margin:0px auto;margin-top:0;margin-bottom:0;">
		...
		<img src="../../static/revslider/assets/transparent.png" class="rev-slidebg" data-no-retina>
		<!--
		--><rs-layer
		...
		>
		<img src="../../static/revslider/assets/index-7/bg.png" alt="img" width="1511" height="1083" data-no-retina>
		</rs-layer><!--
		--><rs-layer
		id="slider-3-slide-3-layer-2"
		data-type="image"
		data-rsp_ch="on"
		data-xy="x:l,l,c,c;xo:726px,726px,0,3px;y:t,t,t,m;yo:113px,113px,335px,147px;"
		data-text="w:normal;s:20,20,9,5;l:0,0,12,7;"
		data-dim="w:869px,869px,297px,298px;h:597px,597px,204px,205px;"
		data-frame_0="y:100%;"
		...
		><img src="../../static/revslider/assets/index-7/02-min.png" alt="img" width="907" height="623" data-no-retina>
		</rs-layer><!--
		--><rs-layer
		...
		data-color="#1e1e1e"
		data-rsp_ch="on"
		data-xy="x:l,l,c,c;xo:170px,170px,-7px,-4px;y:m;yo:-90px,-90px,-153px,-144px;"
		...
		data-color="#8e989f"
		data-rsp_ch="on"
		data-xy="x:l,l,c,c;xo:170px,170px,9px,8px;y:m;yo:39px,39px,-62px,-67px;"
		data-text="w:normal;s:16,16,18,14;l:28,28,28,24;a:left,left,center,center;"
		data-frame_0="y:100%;"
		data-frame_0_mask="u:t;"
		...
		data-type="button"
		data-rsp_ch="on"
		data-xy="x:l,l,c,c;xo:173px,173px,0,1px;y:t,t,m,m;yo:462px,462px,4px,-2px;"
		data-text="w:normal;s:16,16,14,14;l:40,40,18,26;"
		data-dim="minh:0px,0px,none,none;"
		data-padding="t:4,4,12,8;r:25;b:4,4,12,8;l:25;"
		...
		style="z-index:16;background:linear-gradient(90deg, rgba(109,115,239,1) 0%, rgba(163,120,252,1) 100%);font-family:var(--body-font-family);"
		>Read More
		</rs-layer><!--
		--><rs-layer
		...
		><img src="../../static/revslider/assets/index-7/17-1.png" alt="img" width="15" height="15" data-no-retina>
		</rs-layer><!--
		--><rs-layer
		...
		><img src="../../static/revslider/assets/index-7/16-1.png" alt="img" width="20" height="20" data-no-retina>
		</rs-layer><!--
		--><rs-layer
		...
		><img src="../../static/revslider/assets/index-7/10-2.png" alt="img" width="11" height="11" data-no-retina>
		</rs-layer><!--
		--><rs-layer
